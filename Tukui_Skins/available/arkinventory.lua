...
TukuiDB.skins.ArkInventory = {}
TukuiDB.skins.ArkInventory.name = "ArkInventory"
TukuiDB.skins.ArkInventory.skinned = true
local r = { 1, 2, 6, 7, 8, 9 }--TukuiDB.skins.ArkInventory.Right or { 1, 2, 6, 7, 8, 9 }
local l = { 3, 4, 5 }--TukuiDB.skins.ArkInventory.Left or { 3, 4, 5 }
local _G = _G
...
GameTooltip:SetScript( "OnUpdate", gtUpdate )

...
if TukuiDB.level >= 30 and TukuiDB.myclass == "SHAMAN" then
	MultiCastActionBarFrame:SetParent(TukuiShift)
	MultiCastActionBarFrame:SetWidth(0.01)

	MultiCastSummonSpellButton:SetParent(TukuiShift)
	MultiCastSummonSpellButton:ClearAllPoints()
	MultiCastSummonSpellButton:SetPoint("BOTTOMLEFT", TukuiShift, 0, TukuiDB.Scale(29))

	for i=1, 4 do
		_G["MultiCastSlotButton"..i]:SetParent(TukuiShift)
	end
...
BonusActionBarFrame:HookScript("OnShow", function(self) BonusBarAlpha(0.1) end)
